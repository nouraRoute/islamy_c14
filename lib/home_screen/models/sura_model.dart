class SuraModel {
  ...
  static List<SuraModel> get suras => getSuras();

  static List<SuraModel> getSuras() {
    List<SuraModel> suras = [];
    for (var i = 0; i < arabicAuranSuras.length; i++) {
      SuraModel sura = SuraModel(
          arName: arabicAuranSuras[i],
          enName: englishQuranSurahs[i],
